...
'please input your password again': 'please enter your password again!!',
'Plugins': 'Plugins',
...
'User ID': 'User ID',
'value already in database or empty': 'Field is empty!!',
'Value not allowed': 'Select value!!',
'Value not in database': 'Fill the fields!!',
